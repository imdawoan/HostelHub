...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
                    <form method="post" action="verify_admin_code.php">
                        ...
                        <button type="submit" name="verify_admin_code" class="btn btn-primary" style = "margin-bottom: 12px; width: 100%; background-color: #637265;border: 1px solid #8770A4">Verify</button>
