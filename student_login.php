                    ...
                    <form method="post" action="student_login.php">
                        ...
                        <div class = "col mb-2">
                            ...
                            <div id="key-input" class="key-input" style = "margin-bottom: 20px;">
                                <input type="text" id="ip1" name="student_username" class="form-control" aria-label="With textarea" placeholder = "Username" autocomplete="off" required>
                            </div>
                            <!--password-->
                            <div id="key-input" class="key-input" style = "margin-bottom: 20px;">
                                    <input type="password" id="ip1" name="student_password" class="form-control" aria-label="With textarea" placeholder = "Password" autocomplete="off" required>
                            </div>
                            <!--button-->
                            <button type="submit" name="login_student" class="btn btn-primary" style = "margin-bottom: 12px; width: 100%; background-color: #637265;border: 1px solid #8770A4">Login</button>        
                            <?php include('error_handling.php'); ?>
                        </div>
                        <p style = "font-size: 14px; text-align: center;color: #949eb4;">Not yet a member? <a href="student_register.php" style = "font-size: 14px; color: #000000;text-decoration: none"><b>Sign up</b></a></p>
                    </form>
                </div>
                <div class="col-sm">
                    <img src="student.png" alt="Italian Trulli" style = "height: 80%; width: 100%; margin-top: 39px;">
                </div>
            </div>
        </div>
    </body>
